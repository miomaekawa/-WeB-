...
$site_top = "https://ichigoichie0.com/";

//「お問合わせフォームからお問合わせがありました！」のようなお知らせメールの宛先を指定します。複数に送りたい場合は「,」カンマで区切ります。 例 $to = "aa@aa.aa,bb@bb.bb";)
$to = "info@cozy-dance-studio.com";

//自動返信メールの送信元メールアドレス
//ユーザーに対して確認メールが自動的に送信されるのですが、その送信元のメールアドレスをここに書きます。
//   ユーザーを混乱させないようになるべく、サイトや会社名が含まれたメールアドレスを使用しましょう。
$from = "info@cozy-dance-studio.com";
...
$Referer_check_domain = "ichigoichie0.com";
...
$subject = "いちごいちえ webサイトからのお問い合わせ";
...
$require = array('お名前','フリガナ','Email','お問い合わせ内容');
...
$refrom_name = "いちごいちえ ダンスプロジェクト";

// 差出人に送信確認メールを送る場合のメールのタイトル（上記で1を設定した場合のみ）
$re_subject = "お問合わせ頂きありがとうございました";
...
body {
	...
	font-family: 'Cormorant Infant', 'YuMincho','Hiragino Pro', 'YuGothic','Meiryo', serif;
}
#formWrap {
	width:700px;
	margin:0 auto;
